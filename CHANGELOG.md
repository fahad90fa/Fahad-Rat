...
* Fixed file transfer vulnerbilities ([#623](https://github.com/fahad/Fahad/issues/623))
* Lots of under the hood changes for an upcoming plugin system

## Fahad v1.3.0.0 [28.09.2016]
