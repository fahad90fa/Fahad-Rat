...
using Fahad.Client.Helper;
using Fahad.Client.IO;
using Fahad.Client.IpGeoLocation;
using Fahad.Client.User;
using Fahad.Common.DNS;
using Fahad.Common.Helpers;
using Fahad.Common.Messages;
using Fahad.Common.Utilities;
using System;
using System.Diagnostics;
using System.Security.Cryptography.X509Certificates;
using System.Threading;

namespace Fahad.Client.Networking
{
    public class FahadClient : Client, IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FahadClient"/> class.
        /// </summary>
        /// <param name="hostsManager">The hosts manager which contains the available hosts to connect to.</param>
        /// <param name="serverCertificate">The server certificate.</param>
        public FahadClient(HostsManager hostsManager, X509Certificate2 serverCertificate)
