...
namespace Fahad.Client
{
    ...
    public class FahadApplication : Form
    {
        ...
        /// </summary>
        private FahadClient _connectClient;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FahadApplication"/> class.
        /// </summary>
        public FahadApplication()
        {
        ...
        public void Run()
        {
            ...
            else
            {
                ...
                _connectClient = new FahadClient(hosts, Settings.SERVERCERTIFICATE);
        ...
        private void InitializeMessageProcessors(FahadClient client)
        {
        ...
        private void ShowNotification(object sender, string value)
        {
            ...
            _notifyIcon.ShowBalloonTip(4000, "Fahad Client", value, ToolTipIcon.Info);
        }
